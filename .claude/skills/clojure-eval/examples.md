...
```bash
clj-nrepl-eval -p 7888 "(require '[ascolais.kaiin :as kaiin] :reload)"
```

Then call functions from it:

```bash
clj-nrepl-eval -p 7888 "(kaiin/some-function arg1 arg2)"
```
...
```bash
clj-nrepl-eval -p 7888 "(require '[ascolais.kaiin] :reload)"
```
...
clj-nrepl-eval -p 7888 "(require '[ascolais.kaiin-test] :reload)"
clj-nrepl-eval -p 7888 "(run-tests 'ascolais.kaiin-test)"
```
